...
odoo.define("pos_event_sale.EventTicket", function (require) {
    ...
    const PosResEventTicket = EventTicket =>
        class extends EventTicket {
            initialize(attr, options) {
                Object.assign(this, options);
            }

            getEvent() {
                return this.db.getEventByID(this.event_id[0]);
            }

            getProduct() {
                return this.db.get_product_by_id(this.product_id[0]);
            }
    ...
    Registries.Component.extend(EventTicket, PosResEventTicket);
